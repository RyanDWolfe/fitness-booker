...
StudioClass.create(name: "Cycle60", class_type: "Cycling", description: "60 minute cycling class for hardcore riders.", occupancy: 25, studio_id: 1)
StudioClass.create(name: "Cycle45", class_type: "Cycling", description: "45 minute cycling class for hardcore riders.", occupancy: 50, studio_id: 1)
StudioClass.create(name: "Cycle30", class_type: "Cycling", description: "30 minute cycling class for hardcore riders.", occupancy: 15, studio_id: 1)
